...
//                Kommunicate.openConversation(this@CustomerChatActivity);
//            }
//
//
...
//        })
        val progressDialog = ProgressDialog(this).apply {
            ...
            setMessage(getString(R.string.please_wait_loading))
            setCancelable(false)
            show()
        }
...
//                }
//            })
//        Kommunicate.openConversation(this, null, object : KmCallback {
//            override fun onSuccess(message: Any) {
//                Utils.printLog(this@CustomerChatActivity, "ChatTest", "Launch Success : $message")
//            }
//
//            override fun onFailure(error: Any) {
//                Utils.printLog(this@CustomerChatActivity, "ChatTest", "Launch Failure : $error")
//            }
//        })
//        KmConversationBuilder(this).apply {
//            kmUser = user
//            launchConversation(object : KmCallback {
//                override fun onSuccess(message: Any) {
//                    Log.d("Conversation", "Success : $message")
